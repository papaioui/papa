...
def set_webhook():
    # Replace with your Render URL, e.g., 'https://your-app-name.onrender.com/webhook'
    webhook_url = 'https://your-app-name.onrender.com/webhook'  # Update this!
    bot.remove_webhook()
...
if __name__ == '__main__':
    ...
    logging.info("Starting asyncio loop and Flask app...")
    
    # Run Flask on Render's PORT or default 5000
